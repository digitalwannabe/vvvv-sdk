...
{
    [PluginInfo(Name = "MultiplyWithInt", Category = "BigInteger", Help = "Multiply BigInteger with Int")]
    public class BigSumProductsNode : IPluginEvaluate, IPartImportsSatisfiedNotification, IDisposable
    {
        

        [Input("Operand")]
        public ISpread<BigInteger> FOperand;

        [Input("Factor")]
        public ISpread<int> FFactor;
 ...
 //               SpreadMax = SpreadUtils.SpreadMax(FOperand, FFactor/*,FPA,FPM*/);
                ...
                for (int i = 0; i < SpreadMax; i++)
                {
                    ...
                    var task = Task.Factory.StartNew(() =>
                    {
                        ...
                        BigInteger result = FOperand[index]*FFactor[index];
